...
if ($featureflagbit) {
    ...
    if ($lineartilingformat) {
        $featureflagbit_value = array_search($featureflagbit , FormatFeatureFlags2::TilingFlags);
    ...
    if ($bufferformat) {
        $featureflagbit_value = array_search($featureflagbit , FormatFeatureFlags2::BufferFlags);
        assert($featureflagbit_value);
