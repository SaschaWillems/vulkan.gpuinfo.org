<?php
	...
	*/
	...
	$report_data = array_merge(array("\$schema" => "https://schema.khronos.org/vulkan/devsim_1_0_0.json#"), $report_data);

	$report_data["VkPhysicalDeviceFeatures"] = $report_data["features"];
	unset($report_data["features"]);

	foreach ($report_data["properties"]["limits"] as $name => &$prop) {
		if (is_string($prop)) {
	...
	$report_data["ArrayOfVkExtensionProperties"] = $report_data["extensions"];
	...
	$report_data["ArrayOfVkLayerProperties"] = $report_data["layers"];
