<?php
    ...
    switch ($format_listing_type) {
        case 'lineartiling':
            ...
            $parameter_name = 'lineartilingformatflag';
            $format_flags = $device_format_flags_tiling;
            break;
        case 'optimaltiling':
            $column = 'optimaltilingfeatures';
            $parameter_name = 'optimaltilingformatflag';
            $format_flags = $device_format_flags_tiling;
            break;            
        case 'buffer':
            $column = 'bufferfeatures';
            $parameter_name = 'bufferformatflag';
            ...
            <?php				
                ...
                foreach ($formats as $format_id => $format_coverage) {
                    ...
                    foreach ($format_flags as $k=> $v) {
                        ...
                        echo "<td class='$class'>".round($coverage, 2)."<span style='font-size:10px;'>%</span></td>";
                    }
                    echo "</tr>";
                }
            ?>
