...
<div class='header'>
	<?php echo "<h4>Core 1.1 properties for ".PageGenerator::filterInfo($platform) ?>
</div>
				...
				try {
					...
					foreach ($properties as $property => $coverage) {
						...
						if ($has_coverage) {
							...
							$link = "<a href='displaycoreproperty.php?core=1.1&coreproperty=$property&platform=$platform'>";
