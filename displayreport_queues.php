...
<table id='devicequeues' class='table table-striped table-bordered table-hover table-header-rotated queue-family-table'>
	<thead>
		<tr>
			...
			<th class='caption rotate-45'><div><span>Queue count</span></div></th>
			<th class='caption rotate-45'><div><span>timestampValidBits</span></div></th>
			<th class='caption rotate-45'><div><span>minImageTransferGranularity.width</span></div></th>
			<th class='caption rotate-45'><div><span>minImageTransferGranularity.height</span></div></th>
			<th class='caption rotate-45'><div><span>minImageTransferGranularity.depth</span></div></th>
			<th class='caption rotate-45'><div><span>Supports present</span></div></th>
			<?php			
