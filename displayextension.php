...
if ($result->rowCount() == 0) {
	PageGenerator::errorMessage("<strong>This is not the <strike>droid</strike> extension you are looking for!</strong><br><br>You may have passed a wrong extension name, or the extension is not yet present in the database.");
}
