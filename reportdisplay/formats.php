...
<div class='tab-content'>
	...
	<div id='formats_optimal' class='tab-pane fade in active reportdiv'>
		<?php insertDeviceFormatTable('deviceformats_optimal', $format_data, 'optimaltilingfeatures', $report->flags->has_format_feature_flags_2 ? FormatFeatureFlags2::TilingFlags : $device_format_flags_tiling); ?>
	</div>
	<!-- Linear tiling features -->
	<div id='formats_linear' class='tab-pane fade reportdiv'>
		<?php insertDeviceFormatTable('deviceformats_linear', $format_data, 'lineartilingfeatures', $report->flags->has_format_feature_flags_2 ? FormatFeatureFlags2::TilingFlags : $device_format_flags_tiling); ?>
	</div>
	<!-- Buffer features -->
	<div id='formats_buffer' class='tab-pane fade reportdiv'>
		<?php insertDeviceFormatTable('deviceformats_buffer', $format_data, 'bufferfeatures', $report->flags->has_format_feature_flags_2 ? FormatFeatureFlags2::BufferFlags : $device_format_flags_buffer); ?>
	</div>
</div>